...
public class FinalPrices {
    ...
    public static void main(String[] args) {
        FinalPrices algo = new FinalPrices();
        ArrayUtils.print(algo.finalPrices(new int[] {8,4,6,2,3}));
        ArrayUtils.print(algo.finalPrices(new int[] {1,2,3,4,5}));
        ArrayUtils.print(algo.finalPrices(new int[] {10,1,1,6}));
    }
}
